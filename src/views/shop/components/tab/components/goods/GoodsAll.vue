<template>
  <div class="app-container good-container">
    <div class="pan-btn good-card blue-btn document-btn-style" target="_blank" >
...
.good-container {
  ...
  .good-card:hover {
    ...
    box-shadow: 0px 0px 30px rgba(0,0,0,0.4);   /* 添加阴影 */
  }
  .good-title {
    font-size: 20px;
    font-weight: 600;
