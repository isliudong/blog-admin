  ...
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        ...
        <el-tag v-permission="[2]" class="permission-sourceCode" type="info">
          v-permission="[2]"
        </el-tag>
      </div>
      ...
      <div>
        ...
        <el-tag v-permission="[1,2]" class="permission-sourceCode" type="info">
          v-permission="[1,2]"
        </el-tag>
      </div>
    </div>
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        ...
        <el-tab-pane v-if="checkPermission([2])" label="Editor">
          Editor can see this
          <el-tag class="permission-sourceCode" type="info">
        ...
        <el-tab-pane v-if="checkPermission([1,2])" label="Admin-OR-Editor">
          Both admin or editor can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkPermission([1,2])"
          </el-tag>
        </el-tab-pane>
      </el-tabs>
    </div>
